...
:: Ueberpruefen ob Parameter gesetzt worden
  ...
  IF NOT ""=="%1" (
    IF NOT ""=="%2" (
      ...
      echo "-t <Dateiendung>         Zur Angabe einer Dateiendung, zur Einschr�nkung der auszuf�hrenden Dateien im Testfallverzeichnis (Standard: .txt)"
      ...
      echo "Bitte geben Sie bei der Angabe des Parameters -d zus�tzlich einen Pfad an."
      echo "Bei der Verwendung des Parameters -t geben Sie bitte zus�tzlich eine Dateiendung an."
      echo "Ausfuehrung wird beendet."
      echo "Zum beenden beliebige Taste druecken."
      pause > nul
    )
  ...
  :PARAMCHECK
    IF NOT ""=="%3" (
      IF NOT "%3%" equ "%1%" (
        ...
        echo "Jeder Parameter darf maximal einmal verwendet werden f�r einen Aufruf."
